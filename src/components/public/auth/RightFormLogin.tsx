...
import { FaUser, FaLock, FaListOl } from "react-icons/fa";
import { imagenes } from "../../../assets/img/imagenes";

function RightFormLogin() {
    return (
                ...
                <section className="flex w-full flex-col items-start justify-center gap-4 h-full sm:h-auto">
                    <div className="w-full">
                        ...
                        <TextInput id="user" icon={FaUser} type="text" placeholder="Ingrese su usuario..." required
                            // value={usuario.cedula} onChange={handleChange} 
                            name="user" />
                    </div>
                    <div className="w-full">
                        <div className="mb-2 block">
                    ...
                    <div className="w-full">
                        ...
                        <TextInput id="code" type="password" placeholder="••••••••••••••••" required name="code" icon={FaListOl}
                        // value={usuario.password} onChange={handleChange} 
                        />
                    </div>
                    <button
